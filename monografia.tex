...
%     legend box/.style={rectangle, draw, minimum size=12pt},
%     axis/.style={black, semithick, ->},
%     axis label/.style={anchor=east,font={\tiny}},
%   },
%   pie chart/.style={
%     chart,
%     slice/.style={line cap=round, line join=round, semithick, draw=lightgray},
%     pie title/.style={font={\bfseries}},
%     slice type/.style n args={3}{
%         ##1/.style={pattern color=##2,pattern=##3},
%         values of ##1/.style={fill=white,fill opacity=0.75}
%     }
% }}
...
%     \foreach \n/\s in {#2}
%     {
%       ++(0,-6pt) node[\s,legend box] {} +(3pt,0) node[legend label] {\n}
%     };
%     \end{scope}
% }
...
% -------------------------------------------------------------------------------------------------
\titulo{ERText: Uma Linguagem Específica de Domínio para a Representação de Modelos Conceituais de Bancos de Dados Relacionais}
...
\DeclareAcronym{ESE}{
  short = ESE,
  long  =  Engenharia de Software Experimental,
  class = acronimos
}

\DeclareAcronym{TCLE}{
  short = TCLE,
  long  =  Termo de Consentimento Livre e Esclarecido,
  class = acronimos
}
...
\input{textuais/1introducao}
\input{textuais/2metodologiaPesquisa}
\input{textuais/3fundamentacaoTeorica}
\input{textuais/4mapeamentoMultivocalLiteratura}
\input{textuais/5propostaDSL}
\input{textuais/6validacao.tex}
\input{textuais/7consideracoesPreliminares}
